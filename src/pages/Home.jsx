...
function Home() {
  return (
   ...
   <div className="w-100 d-flex justify-content-center align-items-center rounded bb" style={{height:'900px'}}>
                        <div className="container">
                            <div className="row align-items-center ">
                                <div className="col-lg-4 fw-bolder text-dark mb-3">
                                <img className='img-fluid'  src={regstu} alt="landing" />
                                    <h1 style={{fontSize:'80px'}} className='fw-bolder  mb-3 hh ' >    Welcome     </h1>
